...
class Digitalboard {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Digitalboard_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'DIGITALBOARD_VERSION' ) ) {
			$this->version = DIGITALBOARD_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'digitalboard';
	 ...
	 *
	 * - Digitalboard_Loader. Orchestrates the hooks of the plugin.
	 * - Digitalboard_i18n. Defines internationalization functionality.
	 * - Digitalboard_Admin. Defines all hooks for the admin area.
	 * - Digitalboard_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies(){
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-digitalboard-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-digitalboard-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-digitalboard-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-digitalboard-public.php';

		$this->loader = new Digitalboard_Loader();
	 ...
	 *
	 * Uses the Digitalboard_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Digitalboard_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Digitalboard_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Digitalboard_Public( $this->get_plugin_name(), $this->get_version() );
		$this->loader->add_filter( 'sk_breadcrumbs', $plugin_public, 'breadcrumbs' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Digitalboard_Loader    Orchestrates the hooks of the plugin.
	 */
